<template>
    <div class="box">
        <h1>プライバシーポリシー</h1>
        <p>個人事業主としての屋号：Kre8iv21（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
        <dl>
            <dt>第1条（個人情報）</dt>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>第三者に提供されるデータの目</li>
                                    <li>第三者への提供の手段または方法項</li>
            ...
            <dd>
                ...
                <div class="contact">
                    <ul>
                        <li>個人事業主としての屋号：Kre8iv21</li>
                        <li>個人情報取扱責任者：小泉 勝也</li>
                        <li>Eメールアドレス：kre8iv.21@gmail.com</li>
                    </ul>
                </div>
            </dd>
        </dl>
